...
export const accounts: AccountData = [
	{
		...
		accounts: [
			...
			{
				site: "Bluesky",
				username: "hans5958.id",
				url: "https://bsky.app/profile/did:plc:bwowy3hw2uitqb4c2qt4tod3",
				icon: "simple-icons:bluesky",
				iconStyle: "color: #006aff",
				note: "Rarely used in favor of Mastodon. Mastodon account is bridged on @masto.hans5958.id.",
				dormant: true
			},
			{
				site: "Telegram",
	...
	},
	{
		...
		accounts: [
			...
			},
			{
				site: "Pastebin",
				username: "Hans5958",
				url: "https://pastebin.com/u/Hans5958",
				icon: "simple-icons:pastebin",
				iconStyle: "color: #02456C"
			},
			{
				site: "Straw.Page",
				username: "Hans5958",
				url: "https://hans5958.straw.page",
				iconImg: "https://straw.page/apple-touch-icon.png?v=2",
			},
			{
				site: "DeviantArt",
				username: "Hans5958",
				url: "https://deviantart.com/Hans5958",
				icon: "simple-icons:deviantart",
				iconStyle: "color: #05CC47",
				dormant: true
			}
		]
	}
