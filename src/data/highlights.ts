...
const highlights = [
	...
	{
		"name": "Scratch Addons",
		"description": "A browser extension for Scratch website. Mainly as a website maintainer, but occasionally contributes in the main project.",
		"link": "https://scratchaddons.com",
		"image": "https://scratchaddons.com/assets/img/showcase/popup-light.png"
	},
	{
	...
	},
	{
		...
		"description": "Repository of Black MIDI meta texts and stuff.",
		"link": "https://github.com/Hans5958/Black-MIDI-Meta"
	},
	{
		"name": "Pixel Adblock Filters",
		"description": "Personal ad block filters (it blocks more than ads). Mainly made for usage with uBlock Origin.",
		"link": "https://github.com/Hans5958/Pixel-Adblock-Filters"
	},
	{
		"name": "MediaWiki Scripts",
		"description": "Collection of scripts for editing in MediaWiki sites (also known as wikis), such as Wikipedia, Fandom, etc.",
